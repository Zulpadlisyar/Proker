      ...
      return `
        <div class="news-card">
          <div class="news-img-wrapper">
            <img src="${activity.image || 'images/default_activity.webp'}" alt="${activity.title}" class="news-img" loading="lazy" decoding="async" onload="this.classList.add('img-loaded')" onerror="this.onerror=null; this.src='images/default_activity.webp'; this.classList.add('img-loaded');">
    ...
    return `
      <article class="news-card-item">
        <div class="news-img-wrap">
          <img src="${activity.image || 'images/default_activity.webp'}" alt="${activity.title}" width="960" height="540" loading="lazy" decoding="async" onload="this.classList.add('img-loaded')" onerror="this.onerror=null; this.src='images/default_activity.webp'; this.classList.add('img-loaded');">
          <span class="news-badge-tag">${category}</span>
        </div>
